// Import React core library, useState, useEffect, and useRef hooks
...
function AIPredictor() {
  ...
  useEffect(() => {
    runAIDiagnostics();
  }, []); // Empty dependency array [] means this effect runs exactly once when component loads
    ...
    <div className="ai-predictor-container">
      ...
      <div className="mission-grid">
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                step="50"
                value={altitude}
                // Update altitude state on slider move
            ...
            <div className="form-group">
              ...
              <input
                ...
                step="5"
                value={signalNoise}
                // Update signalNoise state on slider move
            ...
            <div className="form-group">
              ...
              <select
                value={batteryHealth}
                // Update batteryHealth state on dropdown selection
        ...
        <div className="card mission-card">
          ...
          {/* Render loading text or AI analysis output */}
          {isAnalyzing ? (
...
// Export AIPredictor component for routing in App.jsx
